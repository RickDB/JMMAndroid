...
namespace JMMAndroid
{
    public class AnimePluginSettings
    {
        ...
        public static string TorrentSourcesAll = JMMAndroid.Constants.TorrentSourceNames.Nyaa + ";" +
                                                 JMMAndroid.Constants.TorrentSourceNames.TT + ";" +
                                                 JMMAndroid.Constants.TorrentSourceNames.BakaBT + ";" +
                                                 JMMAndroid.Constants.TorrentSourceNames.AnimeSuki + ";" +
                                                 JMMAndroid.Constants.TorrentSourceNames.BakaUpdates + ";" +
                                                 JMMAndroid.Constants.TorrentSourceNames.AnimeBytes + ";";
...
/*
        ...
        public string MediaFolder { return;
    ...
    public bool TorrentsTT
{
    get
    {
        return TorrentSources.Contains(JMMAndroid.Constants.TorrentSourceNames.TT);
    }
}

    public
bool TorrentsAnimeSuki
{
    get
    {
        return TorrentSources.Contains(JMMAndroid.Constants.TorrentSourceNames.AnimeSuki);
    }
}
...
bool TorrentsBakaBT
{
    get
    {
        return TorrentSources.Contains(JMMAndroid.Constants.TorrentSourceNames.BakaBT);
    }
}

    public
bool TorrentsAnimeBytes
{
    get
    {
        return TorrentSources.Contains(JMMAndroid.Constants.TorrentSourceNames.AnimeBytes);
    }
}

    public
bool TorrentsBakaUpdates
{
    get
    {
        return TorrentSources.Contains(JMMAndroid.Constants.TorrentSourceNames.BakaUpdates);
    }
}
...
{
    get    {
        return TorrentSources.Contains(JMMAndroid.Constants.TorrentSourceNames.Nyaa);
    }
}
		...
		public TorrentSource DefaultTorrentSource
		{
			get
			{
				...
				if (TorrentSources[0] == JMMAndroid.Constants.TorrentSourceNames.AnimeSuki) return TorrentSource.AnimeSuki;
				if (TorrentSources[0] == JMMAndroid.Constants.TorrentSourceNames.BakaBT) return TorrentSource.BakaBT;
				if (TorrentSources[0] == JMMAndroid.Constants.TorrentSourceNames.AnimeBytes) return TorrentSource.AnimeBytes;
				if (TorrentSources[0] == JMMAndroid.Constants.TorrentSourceNames.BakaUpdates) return TorrentSource.BakaUpdates;
				if (TorrentSources[0] == JMMAndroid.Constants.TorrentSourceNames.Nyaa) return TorrentSource.Nyaa;
				if (TorrentSources[0] == JMMAndroid.Constants.TorrentSourceNames.TT) return TorrentSource.TokyoToshokan;
